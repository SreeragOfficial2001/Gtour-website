...
const Adventure = () => {
  return (
    <div className="bg-black text-white py-16 min-h-20"> {/* Increased height */}
      <div className="container mx-auto px-4">
        <div className="text-center">
          <h1 className="text-5xl font-semibold mb-6"> {/* Larger heading */}
            This adventure isn't about change but it seems to be an inevitability.
          </h1>
          <p className="text-lg mb-10"> {/* Larger paragraph */}
        ...
        <div className="flex justify-center space-x-20">
          <div>
            <p className="text-6xl font-bold">0</p> {/* Larger stats */}
            <p className="text-xl">Trips</p> {/* Larger label */}
          </div>
          <div>
